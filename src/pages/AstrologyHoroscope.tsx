...
export default function AstrologyHoroscope() {
  return (
    <div className="text-left max-w-4xl mx-auto space-y-6 pt-2 pb-16 px-4 font-sans text-slate-800">
      <div className="text-center mb-4">
        <h2 className="text-3xl font-bold text-indigo-950 font-cinzel mb-2">Astrology / Horoscope</h2>
      ...
      <div className="space-y-6 text-sm leading-relaxed font-medium">
        ...
        <div className="bg-purple-50/40 p-6 rounded-2xl border border-purple-100/50 space-y-4">
          ...
          <p>
            ...
            1] New computerized Horoscope Single Page.. <br className="hidden md:block" /> <br className="md:hidden" />
            2]. More than 35 pages with general predictions.. <br className="hidden md:block" /> <br className="md:hidden" />
            3]. Manually Caculated ( based on your birth star - begin and finish ) <br className="hidden md:block" /> <br className="md:hidden" /> Accurate Current 360--&gt;365[365.25]366 Days?!..<br className="hidden md:block" /> <br className="md:hidden" /> Dasaa Bhukthi Antharam Chart for 120 years from Birth Date, Time and Dasaa Years-Months-Days-Hrs-Mints-Seconds Balance.. <br className="hidden md:block" /> <br className="md:hidden" /> Multi Lingual.16 A4 pages. Sample pdf: <a href="https://drive.google.com/file/d/1ZyQHq9J2QEGffedkcsCJIVBKybZ9kHxe/view?usp=sharing" target="_blank" rel="noreferrer" className="text-xs text-blue-600 hover:text-blue-800 underline ml-1">Click Here to View</a> <br className="hidden md:block" /> <br className="md:hidden" /> First and Only.. Created by :Ravi rangaswamee.,M.A.,PG.D.E.A.,
          </p>
        </div>
      </div>
      ...
      <div className="bg-amber-50/50 p-6 rounded-2xl border border-amber-200/50 space-y-4 text-sm font-medium">
        <p>
          ...
          <p className="text-green-700 font-semibold text-base mb-2">
            Each Horoscope Consultation will Take Minimum 1:30 hr, Plan Accordingly.<br />
      ...
      <div className="flex justify-center mt-12">
        <button
          onClick={() => {
            const encoded = encodeURIComponent("Hello Astrology Temple! I Want to Know More About Your Astrology / Horoscope Consultations.");
