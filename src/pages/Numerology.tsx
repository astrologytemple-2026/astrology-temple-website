  ...
  return (
    <div className="text-left max-w-4xl mx-auto space-y-8 pt-2 pb-16 px-4 font-sans text-slate-800">
      <div className="text-center mb-4">
        <h2 className="text-3xl font-bold text-indigo-950 font-cinzel mb-2">Numerology / Nameology / Phonology / Scriptology</h2>
      </div>
      ...
      <div className="flex justify-center mt-12">
        <button
          onClick={() => {
            const encoded = encodeURIComponent("Hello Astrology Temple! I Want to Know More About Your Numerology Consultations.");
