...
export default function AuspiciousDate() {
  return (
    <div className="text-left max-w-4xl mx-auto space-y-8 pt-8 pb-16 px-4 font-sans text-slate-800">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold text-indigo-950 font-cinzel mb-4">Auspicious Date Selections</h2>
      </div>
      ...
      <div className="space-y-6 text-sm leading-relaxed font-medium">
        <div className="bg-indigo-50/40 p-6 rounded-2xl border border-indigo-100/50">
          <p>
            <span className="font-bold text-indigo-900">Vanakkam..</span> Full Prepaid Fees To Refer The Auspicious Day Date Time <br className="hidden md:block" /> <br className="md:hidden" /> INRs @@@@/one and two birth star @ 30 days Period..
          </p>
        </div>
        <div className="bg-emerald-50/40 p-6 rounded-2xl border border-emerald-100/50">
          <p>
            <span className="font-bold text-indigo-900">Vanakkam..</span> Full Prepaid Fees To Refer The Auspicious Day Date Time <br className="hidden md:block" /> <br className="md:hidden" /> INRs @@@/one and two birth star @ 20 days Period..
          </p>
        </div>
      </div>
      ...
      <div className="flex justify-center mt-12">
        <button
          onClick={() => {
            const encoded = encodeURIComponent("Hello Astrology Temple! I Want to Know More About Your Auspicious Date Selections Consultations.");
